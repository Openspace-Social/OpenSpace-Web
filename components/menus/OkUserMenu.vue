    ...
    <nav class="menu has-padding-20">
        <ul class="menu-list">
            <li class="has-padding-bottom-5">
                <button
                    class="button is-success is-rounded is-fullwidth has-background-rainbow has-text-weight-bold justify-center align-items-center"
...
export default class OkUserMenu extends Vue {
    ...
    async onInvitesClick() {
        this.$emit("leaveMenu");
        // const data = await this.userService.getUserInvites({
        //     isStatusPending: false,
        // })
        // console.log(data);
        await this.modalService.openUserInvitesModal();
    }
}
</script>
