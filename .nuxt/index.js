...
import nuxt_plugin_pluginrouting_6010218a from 'nuxt_plugin_pluginrouting_6010218a' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_6c9573b6 from 'nuxt_plugin_pluginmain_6c9573b6' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_localforage_46201351 from 'nuxt_plugin_localforage_46201351' // Source: ./localforage.js (mode: 'client')
import nuxt_plugin_axios_1024f488 from 'nuxt_plugin_axios_1024f488' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_sentryserver_1d4bc980 from 'nuxt_plugin_sentryserver_1d4bc980' // Source: ./sentry.server.js (mode: 'server')
import nuxt_plugin_sentryclient_90db5010 from 'nuxt_plugin_sentryclient_90db5010' // Source: ./sentry.client.js (mode: 'client')
import nuxt_plugin_router_8be0851a from 'nuxt_plugin_router_8be0851a' // Source: ./router.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_pluginrouting_6010218a === 'function') {
    await nuxt_plugin_pluginrouting_6010218a(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_6c9573b6 === 'function') {
    await nuxt_plugin_pluginmain_6c9573b6(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_localforage_46201351 === 'function') {
    await nuxt_plugin_localforage_46201351(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_1024f488 === 'function') {
    await nuxt_plugin_axios_1024f488(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_sentryserver_1d4bc980 === 'function') {
    await nuxt_plugin_sentryserver_1d4bc980(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_sentryclient_90db5010 === 'function') {
    await nuxt_plugin_sentryclient_90db5010(app.context, inject)
  }

  if (typeof nuxt_plugin_router_8be0851a === 'function') {
    await nuxt_plugin_router_8be0851a(app.context, inject)
  }
