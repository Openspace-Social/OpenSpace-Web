...
import nuxt_plugin_pluginrouting_4ee9a84e from 'nuxt_plugin_pluginrouting_4ee9a84e' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_79da543e from 'nuxt_plugin_pluginmain_79da543e' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_localforage_a00243e6 from 'nuxt_plugin_localforage_a00243e6' // Source: ./localforage.js (mode: 'client')
import nuxt_plugin_axios_8f0be510 from 'nuxt_plugin_axios_8f0be510' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_sentryserver_eaba5588 from 'nuxt_plugin_sentryserver_eaba5588' // Source: ./sentry.server.js (mode: 'server')
import nuxt_plugin_sentryclient_24e963b4 from 'nuxt_plugin_sentryclient_24e963b4' // Source: ./sentry.client.js (mode: 'client')
import nuxt_plugin_router_0b142d37 from 'nuxt_plugin_router_0b142d37' // Source: ./router.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_pluginrouting_4ee9a84e === 'function') {
    await nuxt_plugin_pluginrouting_4ee9a84e(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_79da543e === 'function') {
    await nuxt_plugin_pluginmain_79da543e(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_localforage_a00243e6 === 'function') {
    await nuxt_plugin_localforage_a00243e6(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_8f0be510 === 'function') {
    await nuxt_plugin_axios_8f0be510(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_sentryserver_eaba5588 === 'function') {
    await nuxt_plugin_sentryserver_eaba5588(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_sentryclient_24e963b4 === 'function') {
    await nuxt_plugin_sentryclient_24e963b4(app.context, inject)
  }

  if (typeof nuxt_plugin_router_0b142d37 === 'function') {
    await nuxt_plugin_router_0b142d37(app.context, inject)
  }
