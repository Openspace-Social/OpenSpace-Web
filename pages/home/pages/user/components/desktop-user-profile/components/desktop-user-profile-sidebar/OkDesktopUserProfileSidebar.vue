<template>
    <div class="card ok-has-background-primary ok-desktop-user-profile-sidebar">
        <div class="card-header ok-has-border-bottom-primary-highlight" v-if="headerVisible">
            <div
                class="columns has-padding-left-20 has-padding-right-20 has-padding-top-10 has-padding-bottom-10 has-width-100-percent is-marginless">
        ...
        <div :class="{'ok-has-border-bottom-primary-highlight': user.profile.bio}">
            ...
            <div v-if="user.profile.bio"
                 class="content ok-has-text-primary-invert has-padding-top-10 has-padding-right-20 has-padding-left-20 has-padding-bottom-20">
              ...
              <div class="community" v-for="community in displayedCommunities" :key="community.id">
                <a :href="`/c/${community.community_name}`">
                  <figure class="image is-square">
                    <img :src="getAvatarUrl(community.community_avatar)" alt="Community Avatar" class="thumbnail"
                         @error="onImageError">
                  </figure>
